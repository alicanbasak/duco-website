                ...
                <div className="container mil-p-120-0">
                    ...
                    <div className="mil-mb-120">
                        ...
                        <div className="mil-complex-text justify-content-center mil-up mil-mb-15">
                            <span className="mil-text-image"><img src="/images/Homepage/StrategicVision.webp" alt="Strategic Vision" /></span>
                    ...
                    <div className="row mil-services-grid m-0">
                        ...
                        <div key={`services-item-${key}`} className="col-md-6 col-lg-5-items mil-services-grid-item p-0">
