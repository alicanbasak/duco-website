  ...
  return (
    ...
    <div className={`mil-menu-frame ${toggle ? "mil-active" : ""}`}>
        ...
        <div className="mil-frame-top">
            ...
            <img src="/images/logo.png" alt="Duco Istanbul" style={{height: "50px"}} />
          </Link>
                          ...
                          <div className="mil-menu-right">
                              <div className="row">
                                  <div className="col-lg-8 mil-mb-60">
                                      ...
                                      <ul className="mil-menu-list">
                                          ...
                                          <li><Link href="/projects/project-2" className="mil-light-soft">CONSUS Energy</Link></li>
                                          <li><Link href="/projects/project-3" className="mil-light-soft">Barbakuli Meze Bar</Link></li>
                                          <li><Link href="/projects/project-4" className="mil-light-soft">Global Investments Holding</Link></li>
                                          <li><Link href="/projects/project-5" className="mil-light-soft">Global Ports Holding</Link></li>
                                          <li><Link href="/projects/project-6" className="mil-light-soft">Cruise Genie App</Link></li>
                                      </ul>
                              ...
                              <div className="row justify-content-between">
                                  ...
                                  <div className="col-lg-12 mil-mb-60">
                                      ...
                                      <h6 className="mil-muted mil-mb-30">TURKEY</h6>
